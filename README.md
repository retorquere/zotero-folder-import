...
If something does not work, turn on debug logging in the Help menu, reproduce the problem, and choose `Send plugin debug log` from the Help menu. Open an issue and post the debug log ID.
